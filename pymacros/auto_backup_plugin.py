...
class AutoBackupConfigPage(pya.QDialog):
    ...
    def on_reset(self):
        ...
        try:
            ...
            print("AutoBackupConfigPage.on_reset caught an exception", e)
            traceback.print_exc()
    ...
    def on_ok(self):
        ...
        try:
            ...
            print("AutoBackupConfigPage.on_ok caught an exception", e)
            traceback.print_exc()
    ...
    def on_apply(self):
        ...
        try:
            ...
            print("AutoBackupConfigPage.on_apply caught an exception", e)
            traceback.print_exc()
